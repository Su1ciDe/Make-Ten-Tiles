...
namespace Fiber.Utilities
{
	...
	public class ExtendedScriptableObjectDrawer : PropertyDrawer
	{
		public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
		{
			...
			{
				if (property.objectReferenceValue is not SerializedScriptableObject data) return EditorGUIUtility.singleLineHeight;
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			if (!property.hasMultipleDifferentValues && property.serializedObject.targetObject != null && property.serializedObject.targetObject is SerializedScriptableObject)
			{
				propertySO = (SerializedScriptableObject)property.serializedObject.targetObject;
			}
